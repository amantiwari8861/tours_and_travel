...
const hideNavbarFooterRoutes = ["/login", "/signup", "/enquire"];
...
const Layout = () => {
  ...
  return (
    <>
      <ToastContainer />
      <div className="enquire-now flex justify-between items-center w-full mx-auto bg-(--secondary) text-white px-6 py-2 ">
        <a
          href="tel:+918448179216"
          className="call inline-flex gap-3"
          target="_blank"
      ...
      <Navbar />
      <Outlet />
      {hideNavbarFooterRoutes.includes(location.pathname) ? null : <Footer />}
    </>
  );
};
